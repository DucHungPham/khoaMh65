...
static uint8 UserCommandVal[UserCommand_LEN] = {0};

// Simple Profile Characteristic 1 User Description
static uint8 UserCommandDesp[12] = "UserCommand";


// Simple Profile Characteristic 2 Properties
static uint8 UserNotifyProps = GATT_PROP_NOTIFY;

// Characteristic 2 Value
static uint8 UserNotifyVal[UserNotify_LEN] = {0};

// Simple Profile Characteristic 2 User Description
static uint8 UserNotifyDesp[11] = "UserNotify";
...
bStatus_t SimpleProfile_SetParameter( uint8 param, uint8 len, void *value )
{
  ...
  switch ( param )
  {
    ...
    case UserCommand:
      ...
      {
        VOID memcpy( UserCommandVal, value, UserCommand_LEN );
      }
      else
      {
        ret = bleInvalidRange;
...
/*********************************************************************
 * @fn          simpleProfile_ReadAttrCB(read request from A GATT client)
 *
                                           ...
                                           uint8 maxLen, uint8 method )
{
  ...
  if ( pAttr->type.len == ATT_BT_UUID_SIZE )
  {
    ...
    switch ( uuid )
    {
      ...
      //notify request enable form client
      
      case UserNotify_UUID:
        *pLen = UserNotify_LEN;
        //if(*pAttr->pValue == 1) {pValue[0] = 1;*pLen =1; break;}
      ...
      case UserCommand_UUID:
        *pLen = UserCommand_LEN;
        ...
        //-> copy UserCommandVal(pAttr->pValue)->pValue=>GATTSevApp=> OS=> Client
        break;
...
/*********************************************************************
 * @fn      simpleProfile_WriteAttrCB(write request from A GATT client)
 *
    ...
    switch ( uuid )
    {
      case UserCommand_UUID:
        ...
        if ( status == SUCCESS )
        {
          ...
          //*pCurValue = pValue[0];
          //if( pAttr->pValue == &simpleProfileChar1 ) // kiểm tra con trỏ địa chỉ lưu val
          //{
          //  notifyApp = UserCommand;        
          //}
